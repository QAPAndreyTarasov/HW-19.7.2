...
def test_add_new_pet_with_valid_data_without_photo(name='Loken', animal_type='Korgi',
                                                   age='2'):
...
def test_add_new_pet_invalid_age(name='Croco', animal_type='пресмыкающие', age='123'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Ram", "Shepherd dog", "5", "images/Ram.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info_pet_id(name='Loken', animal_type='Dog', age=2):
